...
interval_parameters = [
    (Arb((-0.8, -0.7)), 2000), # Tune more?
    (Arb((-0.7, -0.6)), 2000), # Tune more?
    (Arb((-0.6, -0.5)), 1000), # Tune more?
    (Arb((-0.5, -1 // 3)), 5000), # Tune more?
    (Arb((-1 // 3, -1 // 6)), 50000), # Tune more?
    (Arb((-1 // 6, -0.1)), 1000),
    (Arb((-0.1, -0.05)), 1000),
    (Arb((-0.05, -0.025)), 1000),
...
let bound = 1 .- 2Arblib.sqrtpos.(df.α₀ .* df.δ₀)
    plot(
        df.α,
        [df.C_B_estimate bound],
        ribbon = radius.(Arb, [df.C_B_estimate bound]),
        m = :circle,
